/**
 * @file include/common/tool_info.cpp
...
{
	return utils::containsCaseInsensitive(_name, n)
			|| utils::containsCaseInsensitive(_version, n);
}
...
{
	return utils::containsCaseInsensitive(_version, v);
}
