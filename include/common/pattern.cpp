/**
 * @file include/common/pattern.cpp
...
void Pattern::Match::setOffset(const common::Address& offset)
{
	_offset = offset;
}

void Pattern::Match::setAddress(const common::Address& address)
{
	_address = address;
}
...
common::Address Pattern::Match::getOffset() const
{
	return _offset;
}

common::Address Pattern::Match::getAddress() const
{
	return _address;
}
