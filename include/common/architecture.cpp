...
{
	return utils::containsCaseInsensitive(_name, a);
}
...
{
	if (utils::containsCaseInsensitive(_name, ARCH_UNKNOWN))
	{
		_arch = eArch::UNKNOWN;
	}
	else if (utils::containsCaseInsensitive(_name, ARCH_MIPS))
	{
		_arch = eArch::MIPS;
	}
	else if (utils::containsCaseInsensitive(_name, ARCH_PIC32))
	{
		_arch = eArch::PIC32;
	}
	else if (utils::containsCaseInsensitive(_name, ARCH_THUMB))
	{
		_arch = eArch::ARM;
		_thumbFlag = true;
	}
	else if (utils::containsCaseInsensitive(_name, ARCH_ARM))
	{
		_arch = eArch::ARM;
		_thumbFlag = false;
	}
	else if (utils::containsCaseInsensitive(_name, ARCH_x86))
	{
		_arch = eArch::X86;
	}
	else if (utils::containsCaseInsensitive(_name, ARCH_PPC))
	{
		_arch = eArch::PPC;
	}
}
