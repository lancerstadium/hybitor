/**
 * @file include/common/storage.cpp
...
Storage Storage::inMemory(const common::Address& address)
{
 ...
 */
bool Storage::isMemory(common::Address& globalAddress) const
{
 ...
 */
common::Address Storage::getAddress() const
{
