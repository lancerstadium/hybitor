/**
 * @file include/common/pattern.h
 * @brief Common pattern representation.
 */

#ifndef COMMON_PATTERN_H
#define COMMON_PATTERN_H
		...
		class Match
		{
			public:
				...
				static Match unknown(
						const common::Address& offset
							= common::Address::Undefined,
						const common::Address& address
							= common::Address::Undefined,
				...
				/// @{
				void setOffset(const common::Address& offset);
				void setAddress(const common::Address& address);
				...
				/// @{
				common::Address getOffset() const;
			...
			private:
				Match(const common::Address& offset,
						const common::Address& address,
