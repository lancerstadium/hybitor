/**
 * @file include/common/function.h
...
#include "common/calling_convention.h"
...
using LineNumber = common::Address;
 ...
 */
class Function : public common::AddressRange
{
	public:
		/**
	...
	public:
		...
		void setStartLine(const common::Address& l);
		void setEndLine(const common::Address& l);
...
struct FunctionAddressCompare
{
	...
	bool operator()(const common::Address& id, Function const& f) const
	{
		return id < f.getStart();
	}
	bool operator()(const Function& f, const common::Address& id) const
	{
...
class FunctionContainer : public std::set<Function, FunctionNameCompare>
{
	public:
		...
		const Function* getFunctionByStartAddress(
				const common::Address& addr) const;
...
class FunctionSet : public std::set<
		common::Function,
		common::FunctionAddressCompare>
{
	public:
		const common::Function* getRange(
				const common::Address& a) const;
};
