/**
 * @file include/common/function.cpp
...
void Function::setStartLine(const common::Address& l)       { _startLine = l; }
void Function::setEndLine(const common::Address& l)         { _endLine = l; }
 ...
 */
const common::Function* FunctionSet::getRange(
